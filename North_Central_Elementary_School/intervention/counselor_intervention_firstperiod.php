...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update"])) {
    ...
    $sql = "UPDATE behavioral SET 
            ...
            advice = ?,
            status = ?
            WHERE lrn = ? AND quarter = '1' AND school = 'North Central Elementary School'";
    ...
    if ($stmt->execute()) {
        ...
        $sql_update = "UPDATE behavioral SET status = ? WHERE lrn = ? AND quarter IN ('2','3', '4') AND school = 'North Central Elementary School'";
