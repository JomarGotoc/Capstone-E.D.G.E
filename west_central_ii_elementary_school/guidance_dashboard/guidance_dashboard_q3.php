...
<body>
    ...
    while ($row = $result1->fetch_assoc()) {
        ...
        echo "<tr class='sheshable' style='background-color: $rowColor;'>
                ...
                <a href='../intervention/counselor_intervention_thirdperiod.php?lrn={$row['lrn']}&fullname={$row['fullname']}&classification={$row['classification']}&grade={$row['grade']}&section={$row['section']}&status={$row['status']}' class='updateRecordButton'>UPDATE RECORD</a>
            </th>
            </tr>";
    }
}
