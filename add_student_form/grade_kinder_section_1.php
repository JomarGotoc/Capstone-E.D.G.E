...
$tableName = strtolower($phpFileName); // Convert to lowercase if needed
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit1"])) {
    ...
    if ($stmt->fetch()) {
        ...
        echo "No data found for LRN: $lrn";
    }
...
if(isset($_POST['submit2'])){
    ...
    switch ($classification) {
        ...
        case 'Academic - Literacy in Filipino':
            $sql = "INSERT INTO academic_filipino (lrn, fullname, grade, section, date, quarter, classification)
                    VALUES ('$lrn', '$fullname', '$grade', '$section', '$date', '$quarter', '$classification')";
            break;

        case 'Academic - Numeracy':
            $sql = "INSERT INTO academic_numeracy (lrn, fullname, grade, section, date, quarter, classification)
                    VALUES ('$lrn', '$fullname', '$grade', '$section', '$date', '$quarter', '$classification')";
            break;
...
<body>
    ...
    <form class="main-container" action=" " method="post" id="searchForm" >
                ...
                <div class="row">
                    ...
                    <input type="text" class="column" placeholder="Full Name" name="fullname" id="fullname" value="<?php echo $fullname1; ?>">
                ...
                <div class="row">
                    ...
                    <input type="text" class="column" placeholder="Grade" name="grade" id="grade" value="<?php echo $grade; ?>" >
                    <div class="column">Section </div>
                    <input type="text" class="column" placeholder="Section" name="section" id="section" value="<?php echo $section; ?>">
