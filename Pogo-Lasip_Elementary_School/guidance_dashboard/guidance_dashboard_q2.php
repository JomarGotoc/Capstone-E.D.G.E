<?php
    ...
    $sql = "SELECT lrn, fullname, classification, grade, section, status FROM behavioral WHERE quarter ='2' AND school = 'Pogo-Lasip Elementary School'";
...
<?php
include('../../database.php');
$sql = "SELECT COUNT(DISTINCT lrn) AS count FROM behavioral WHERE lrn IS NOT NULL AND lrn != '' AND school = 'Pogo-Lasip Elementary School'";
