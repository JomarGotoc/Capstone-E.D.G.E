<?php
    ...
    $sql = "SELECT lrn, fullname, classification, grade, section, status FROM behavioral WHERE quarter ='4' AND school = 'Sabangan Elementary School'";
            ...
            <div class="header-content">
                ...
                <i class='bx log-out bx-lock-alt logout-icon' onclick="toggleDropdown()"></i>
                    ...
                    <a href="../../login/Login.php">Log Out</a>
                        <a href="counselor_change_password.php?employment_number=<?php echo isset($_GET['employment_number']) ? $_GET['employment_number'] : 'default_value'; ?>">Change Password</a>
                    </div>
                </div>
            </div>
        </div>
