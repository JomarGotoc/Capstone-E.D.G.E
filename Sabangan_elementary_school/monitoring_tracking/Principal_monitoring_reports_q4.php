...
<?php
    ...
    foreach ($tables as $table) {
        ...
        $sql4 = "SELECT COUNT(DISTINCT lrn) AS total4 FROM $table WHERE grade = 'I' AND quarter = 4 AND school = 'Sabangan Elementary School'";    
        // Execute query
        $result = mysqli_query($conn, $sql);
    ...
    if ($total != 0) {
        $percentage4 = ($updated / $total) * 400;
        $percentage4 = round($percentage4); 
    } else {
        $percentage4 = 0;
    }
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        $sql4 = "SELECT COUNT(DISTINCT lrn) AS total4 FROM $table WHERE grade = 'II' AND quarter = 4 AND school = 'Sabangan Elementary School'";    
        // Execute query
        $result = mysqli_query($conn, $sql);
        $result4 = mysqli_query($conn, $sql4);
    ...
    if ($total != 0) {
        $percentageg2 = ($updated / $total) * 400;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        $sql4 = "SELECT COUNT(DISTINCT lrn) AS total4 FROM $table WHERE grade = 'III' AND quarter = 4 AND school = 'Sabangan Elementary School'";    
        // Execute query
        $result = mysqli_query($conn, $sql);
        $result4 = mysqli_query($conn, $sql4);
    ...
    if ($total != 0) {
        $percentageg3 = ($updated / $total) * 400;
