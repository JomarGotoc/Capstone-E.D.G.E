...
<?php
    ...
    foreach ($tables as $table) {
        ...
        $sql3 = "SELECT COUNT(DISTINCT lrn) AS total3 FROM $table WHERE grade = 'I' AND quarter = 3 AND school = 'Sabangan Elementary School'";    
        // Execute query
        $result = mysqli_query($conn, $sql);
    ...
    if ($total != 0) {
        $percentage3 = ($updated / $total) * 300;
        $percentage3 = round($percentage3); 
    } else {
        $percentage3 = 0;
    }
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        $sql3 = "SELECT COUNT(DISTINCT lrn) AS total3 FROM $table WHERE grade = 'II' AND quarter = 3 AND school = 'Sabangan Elementary School'";    
        // Execute query
        $result = mysqli_query($conn, $sql);
        $result3 = mysqli_query($conn, $sql3);
    ...
    if ($total != 0) {
        $percentageg2 = ($updated / $total) * 300;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        $sql3 = "SELECT COUNT(DISTINCT lrn) AS total3 FROM $table WHERE grade = 'III' AND quarter = 3 AND school = 'Sabangan Elementary School'";    
        // Execute query
        $result = mysqli_query($conn, $sql);
        $result3 = mysqli_query($conn, $sql3);
    ...
    if ($total != 0) {
        $percentageg3 = ($updated / $total) * 300;
