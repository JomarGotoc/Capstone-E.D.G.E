...
$sql = "SELECT * FROM counselor WHERE school = 'Federico N. Ceralde School Integrated School'";
$result1 = $conn->query($sql);

if(isset($_POST['reset_password'])) {
    // Get user ID from the form
    $user_id = $_POST['user_id'];
    $query = "SELECT * FROM counselor  WHERE id = $user_id";
    ...
    if ($result->num_rows > 0) {
        ...
        $update_query = "UPDATE counselor  SET password = '$hashed_password' WHERE id = $user_id";
...
<body>
    ...
    <div class="navbar">
        ...
        <nav>
            ...
            <a href="../school_admin_manage_account/Adviser_Account.php?employment_number=<?php echo isset($_GET['employment_number']) ? $_GET['employment_number'] : 'default_value'; ?>" id="school2-admin">Advisers</a>
            <a href="../school_admin_manage_account/Counselor_Account.php?employment_number=<?php echo isset($_GET['employment_number']) ? $_GET['employment_number'] : 'default_value'; ?>" style="background:#F3F3F3; color:#130550" id="school3-admin">Guidance Counselor</a>
        </nav>
    </div>
    ...
    ?>
            <tr class="sheshable">
                ...
                <td class="rows">
                    ...
                    <a href="counselor_account_edit.php?id=<?php echo $row['id']; ?>&employment_number=<?php echo isset($_GET['employment_number']) ? $_GET['employment_number'] : 'default_value'; ?>"><button class="edit-button">Edit</button></a>
                        <form method="post" action="Counselor_Account.php">
    ...
    <div class="plus-button">
            <a href="../create_account/Create_Counselor_Account.php?employment_number=<?php echo isset($_GET['employment_number']) ? $_GET['employment_number'] : 'default_value'; ?>"><button id="addRecordButton" class="add-button"><i class='bx bx-plus'></i></button></a>
        </div>
