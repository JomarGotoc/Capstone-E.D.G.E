...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update"])) {
    ...
    $sql = "UPDATE behavioral SET 
            ...
            advice = ?,
            status = ?
            WHERE lrn = ? AND quarter = '4' AND school = 'Federico N. Ceralde School Integrated School'";
    $stmt = $conn->prepare($sql);
...
<body>
    ...
    <div class="top-container">
        ...
        <a href="../guidance_dashboard/guidance_dashboard_q4.php?employment_number=<?php echo isset($_GET['employment_number']) ? $_GET['employment_number'] : 'default_value'; ?>" class="back-icon"><i class='bx bx-chevron-left'></i></a>
        </div>
        <div class="school">
