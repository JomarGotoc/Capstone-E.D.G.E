...
foreach ($tables as $table) {
    $sql = "SELECT * FROM $table WHERE lrn = ? AND quarter = '3' AND school = 'Federico N. Ceralde School Integrated School'";
...
if(isset($_POST['print'])) {
        ...
        $redirect_url = "guidance_intervention_print.php?classification=$classification&lrn=$lrn&employment_number=$employment_number&quarter=3";
