...
if (isset($_GET['lrn']) && isset($_GET['classification'])) {
    ...
    foreach ($tables as $table) {
        $query = "SELECT gname, number, grade, section FROM $table WHERE lrn = '$lrn' AND classification = '$classification' AND quarter = '2' AND school = 'Sabangan Elementary School'";
...
<body>
    ...
    <div class="top-container">
        ...
        <div class="school">
            <h3>lWest Central II Elementary School</h3>
        </div>
