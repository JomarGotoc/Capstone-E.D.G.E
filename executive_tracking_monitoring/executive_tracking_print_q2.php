...
<body>
    ...
    <div class="update">
    <a href="executive_tracking_reports_q2.php?employment_number=<?php echo isset($_GET['employment_number']) ? $_GET['employment_number'] : 'default_value'; ?>" > <button class="back-icon"><i class='bx bxs-chevron-left'></i></button></a>
    ...
    <div class="update-record">
        ...
        <input class="response" type="text" value="2" readonly>
    </div>
    ...
    <table>
        <thead>
            <tr>
                <td>Elementary School's Name</td>
                <td># of Students</td>
                <td># of P.A.R</td>
                <td>A - Literacy (E)</td>
                <td>A - Literacy (F)</td>
