<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 3 AND school = 'West Central I Elementary School'";
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 3 AND school = 'West Central I Elementary School' AND gname <> ''";
...
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'West Central I Elementary School' AND quarter = '3'";
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'West Central I Elementary School' AND quarter = '3'";
                break;
