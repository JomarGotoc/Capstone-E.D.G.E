<?php
    ...
    foreach ($tables as $table) {
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Bolosan Elementary School' AND gname <> ''";
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Bacayao Sur Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Bacayao Sur Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Bliss Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Bliss Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Bonuan Boquig Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Bonuan Boquig Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Calmay Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Calmay Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Carael Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Carael Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Caranglaan Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Caranglaan Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'East Central Integrated School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'East Central Integrated School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Federico N. Ceralde School Integrated School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Federico N. Ceralde School Integrated School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Gen. Gregorio Del Pilar Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Gen. Gregorio Del Pilar Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Juan L. Siapno Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Juan L. Siapno Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Juan P. Guadiz Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Juan P. Guadiz Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Lasip Grande Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Lasip Grande Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Leon-Francisco Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Leon-Francisco Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Lomboy Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Lomboy Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Lucao Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Lucao Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Malued Sur Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Malued Sur Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Mamalingling Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Mamalingling Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Mangin-Tebeng Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Mangin-Tebeng Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'North Central Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'North Central Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Pantal Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Pantal Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Pascuala G. Villamil Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Pascuala G. Villamil Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Pogo-Lasip Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Pogo-Lasip Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Pugaro Integrated School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Pugaro Integrated School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Sabangan Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Sabangan Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Salapingao Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Salapingao Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Salisay Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Salisay Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Suit Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Suit Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'T. Ayson Rosario Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'T. Ayson Rosario Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Tambac Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Tambac Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Tebeng Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Tebeng Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Victoria Q. Zarate Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'Victoria Q. Zarate Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'West Central II Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 1 AND school = 'West Central II Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
    ...
    <div class="main-container">
        <div class="row">
            ...
            <div class="containers second">
                <a href="executive_monitoring_print_q1.php?employment_number=<?php echo isset($_GET['employment_number']) ? $_GET['employment_number'] : 'default_value'; ?>">
        ...
        <table border="0">
            ...
            <tr>
                    ...
                    <tr class="school" <?php if ($pascualapercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                        ...
                        <th style="width:12%"><?php echo $totalpascuala ?></th>
