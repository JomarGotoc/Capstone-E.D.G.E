...
foreach ($tables as $table) {
    $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'West Central I  Elementary School'";
    $result = $conn->query($sql);
    ...
    $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'West Central I  Elementary School' AND gname <> ''";
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Bolosan Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Bolosan Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Bacayao Sur Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Bacayao Sur Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Bliss Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Bliss Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Bonuan Boquig Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Bonuan Boquig Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Calmay Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Calmay Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Carael Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Carael Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Caranglaan Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Caranglaan Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'East Central Integrated School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'East Central Integrated School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Federico N. Ceralde School Integrated School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Federico N. Ceralde School Integrated School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Gen. Gregorio Del Pilar Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Gen. Gregorio Del Pilar Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Juan L. Siapno Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Juan L. Siapno Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Juan P. Guadiz Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Juan P. Guadiz Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Lasip Grande Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Lasip Grande Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Leon-Francisco Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Leon-Francisco Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Lomboy Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Lomboy Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Lucao Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Lucao Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Malued Sur Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Malued Sur Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Mamalingling Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Mamalingling Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Mangin-Tebeng Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Mangin-Tebeng Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'North Central Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'North Central Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Pantal Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Pantal Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Pascuala G. Villamil Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Pascuala G. Villamil Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Pogo-Lasip Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Pogo-Lasip Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Pugaro Integrated School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Pugaro Integrated School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Sabangan Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Sabangan Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Salapingao Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Salapingao Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Salisay Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Salisay Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Suit Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Suit Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'T. Ayson Rosario Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'T. Ayson Rosario Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Tambac Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Tambac Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Tebeng Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Tebeng Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Victoria Q. Zarate Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'Victoria Q. Zarate Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'West Central II Elementary School'";
        $result = $conn->query($sql);
        ...
        $sql1 = "SELECT DISTINCT lrn FROM $table WHERE quarter = 2 AND school = 'West Central II Elementary School' AND gname <> ''";
        $result1 = $conn->query($sql1);
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Juan P. Guadiz Elementary School	' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Sabangan Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Bliss Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Bolosan Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Bonuan Boquig Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Calmay Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Carael Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Caranglaan Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'East Central Integrated School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Federico N. Ceralde School Integrated School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Gen. Gregorio Del Pilar Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Juan L. Siapno Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Lasip Grande Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Leon-Francisco Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Lomboy Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Lucao Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Malued Sur Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Mamalingling Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Mangin-Tebeng Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'North Central Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Pantal Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Pascuala G. Villamil Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Pogo-Lasip Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Pugaro-Lasip Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Salapingao Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Salisay Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Suit Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'T. Ayson Rosario Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Tambac Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Tebeng Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Victoria Q. Zarate Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'West Central II Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
$lrn_counted = array(); // Array to keep track of counted LRNs
foreach ($tables as $table) {
    $query = "SELECT DISTINCT lrn FROM $table WHERE school = 'Bacayao Sur Elementary School' AND quarter = '2'";
    $result = $conn->query($query);
    if ($result) {
        while ($row = $result->fetch_assoc()) {
            $lrn = $row['lrn'];
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'West Central II Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'West Central II Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Bacayao Sur Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Bacayao Sur Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Bliss Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Bliss Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Bolosan Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Bolosan Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Bonuan Boquig Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Bonuan Boquig Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Calmay Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Calmay Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Carael Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Carael Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Caranglaan Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Caranglaan Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'East Central Integrated School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'East Central Integrated School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Federico N. Ceralde School Integrated School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Federico N. Ceralde School Integrated School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Gen. Gregorio Del Pilar Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Gen. Gregorio Del Pilar Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Juan L. Siapno Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Juan L. Siapno Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Juan P. Guadiz Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Juan P. Guadiz Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Lasip Grande Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Lasip Grande Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Leon-Francisco Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Leon-Francisco Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Lomboy Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Lomboy Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Lucao Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Lucao Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Malued Sur Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Malued Sur Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Mamalingling Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Mamalingling Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Mangin-Tebeng Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Mangin-Tebeng Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'North Central Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'North Central Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Pantal Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Pantal Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Pascuala G. Villamil Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Pascuala G. Villamil Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Pogo-Lasip Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Pogo-Lasip Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Pugaro Integrated School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Pugaro Integrated School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Sabangan Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Sabangan Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Salapingao Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Salapingao Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Salisay Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Salisay Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Suit Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Suit Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'T. Ayson Rosario Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'T. Ayson Rosario Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Tambac Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Tambac Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Tebeng Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Tebeng Elementary School' AND quarter = '2'";
                break;
...
<?php
    ...
    foreach ($tables as $table) {
        ...
        switch ($table) {
            case 'academic_english':
                $count_sql .= " AND school = 'Victoria Q. Zarate Elementary School' AND quarter = '2'";
                break;
            case 'academic_filipino':
                $count_sql .= " AND school = 'Victoria Q. Zarate Elementary School' AND quarter = '2'";
                break;
...
?>
<?php $currentFileName2 = basename(__FILE__,'_q2.php'); ?>
<!DOCTYPE html>
<html lang="en">
<head>
<script>
    ...
    <section class="shesh">
        ...
        <table border="0">
            ...
            <tr>
                    ...
                    <tr class="school" <?php if ($blisspercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($bolosanpercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($bonuanpercentage == 100) echo 'style="background-color: lightblue"'; ?>>
                    ...
                    <tr class="school" <?php if ($calmaypercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($caraelpercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($caranglaanpercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($eastpercentage == 100) echo 'style="background-color: lightblue;"'; ?>> 
                    ...
                    <tr class="school" <?php if ($federicopercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($genpercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($juanlpercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($juanppercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($lasippercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($leonpercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($lomboypercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($lucaopercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($maluedpercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($mamalinglingpercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($manginpercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($northpercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($pantalpercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($pascualapercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($pogopercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($pugaropercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($sabanganpercentage == 100) echo 'style="background-color: lightblue"'; ?>>
                    ...
                    <tr class="school" <?php if ($salipangaopercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($salisaypercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($suitpercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($aysonpercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($tambacpercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($tebengpercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($victoriapercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                    ...
                    <tr class="school" <?php if ($westpercentage == 100) echo 'style="background-color: lightblue;"'; ?>>
                        <th style="width:40%; text-align: left; padding-left: 10px">West Central I Elementary School</th>
