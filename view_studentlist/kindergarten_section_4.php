...
$sql = "SELECT * FROM grade_kinder_section_4";
...
if (isset($_GET['id'])) {
    ...
    $sql = "DELETE FROM `grade_kinder_section_4` WHERE `id`='$user_id'";
...
<body>
    ...
    <div class="arrow" id="arrow" onclick="toggleNavbar()">
    ...
    <div class="main-container">
        <div class="inner-container">
            ...
            <div class="middle-inner-container"><h3>Kindergarten</h3></div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="button-container">
                                    ...
                                    <a href="../view_studentlist/view_studentlist_one_two.php?id=<?php echo $row['id']; ?>"><button class="delete-button">Delete</button></a>
                                </div>
                            </tr>   
                                <?php       }
    ...
    <div class="sidenavbar" id="sidenavbar">
            <div class="blue" onclick="toggleOptions(this, 'kindergarten')">Kindergarten</div>
            <div class="options"></div>
            <div class="blue" onclick="toggleOptions(this, 'grade1')">Grade 1</div>
            <div class="options"></div>
            <div class="blue" onclick="toggleOptions(this, 'grade2')">Grade 2</div>
            <div class="options"></div>
            <div class="blue" onclick="toggleOptions(this, 'grade3')">Grade 3</div>
            <div class="options"></div>
    </div>
