...
$sql = "SELECT * FROM grade_kinder_section_2";
...
if (isset($_GET['id'])) {
    ...
    $sql = "DELETE FROM `grade_kinder_section_2` WHERE `id`='$user_id'";
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="view_studentlist_kinder_one.php<?php if (isset($row['id'])) echo '?id=' . $row['id']; ?>"><button class="delete-button">Delete</button></a>
