...
$sql = "SELECT * FROM grade_kinder_section_1";
...
if (isset($_GET['id'])) {
    ...
    $sql = "DELETE FROM `grade_kinder_section_1` WHERE `id`='$user_id'";
            ...
            <tr>
                ...
                <td>
                    <div class="button-container">
                        <a href="../try.php?id=<?php echo $row['id'] ?>"><button class="edit-button">Edit</button></a>
                        <a href="../view_studentlist/view_studentlist_kinder_one.php?id=<?php echo $row['id']; ?>"><button class="delete-button">Delete</button></a>
