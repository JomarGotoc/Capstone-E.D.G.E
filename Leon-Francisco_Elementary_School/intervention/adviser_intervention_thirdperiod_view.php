...
if (isset($_GET['lrn']) && isset($_GET['classification'])) {
    ...
    $english_query = "SELECT fullname, grade, section, gname, number, status, notes, intervention, topic, advice FROM academic_english WHERE lrn = '$lrn' AND classification = '$classification' AND quarter = '3' AND school = 'Leon-Francisco Elementary School'";

    // Query to fetch data from academic_filipino table
    $filipino_query = "SELECT fullname, grade, section, gname, number, status, notes, intervention, topic, advice FROM academic_filipino WHERE lrn = '$lrn' AND classification = '$classification' AND quarter = '3' AND school = 'Leon-Francisco Elementary School'";

    // Query to fetch data from academic_numeracy table
    $numeracy_query = "SELECT fullname, grade, section, gname, number, status, notes, intervention, topic, advice FROM academic_numeracy WHERE lrn = '$lrn' AND classification = '$classification' AND quarter = '3' AND school = 'Leon-Francisco Elementary School'";

    // Query to fetch data from behavioral table
    $behavioral_query = "SELECT fullname, grade, section, gname, number, status, notes, intervention, topic, advice FROM behavioral WHERE lrn = '$lrn' AND classification = '$classification' AND quarter = '3' AND school = 'Leon-Francisco Elementary School'";
