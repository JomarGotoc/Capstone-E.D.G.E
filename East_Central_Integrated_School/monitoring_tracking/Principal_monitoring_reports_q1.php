...
<?php
    ...
    $sql = "SELECT
                (SELECT COUNT(DISTINCT lrn) FROM (
                    SELECT lrn FROM academic_english WHERE grade = 'kinder' AND quarter = '1' AND school = 'East Central Integrated School'
                    UNION
                    SELECT lrn FROM academic_filipino WHERE grade = 'kinder' AND quarter = '1' AND school = 'East Central Integrated School'
                    UNION
                    SELECT lrn FROM academic_numeracy WHERE grade = 'kinder' AND quarter = '1' AND school = 'East Central Integrated School'
                    UNION
                    SELECT lrn FROM behavioral WHERE grade = 'kinder' AND quarter = '1' AND school = 'East Central Integrated School'
                ) AS kinder_lrns) AS totalkinder,
                (SELECT COUNT(DISTINCT lrn) FROM (
                    SELECT lrn FROM academic_english WHERE grade = 'I' AND quarter = '1' AND school = 'East Central Integrated School'
                    UNION
                    SELECT lrn FROM academic_filipino WHERE grade = 'I' AND quarter = '1' AND school = 'East Central Integrated School'
                    UNION
                    SELECT lrn FROM academic_numeracy WHERE grade = 'I' AND quarter = '1' AND school = 'East Central Integrated School'
                    UNION
                    SELECT lrn FROM behavioral WHERE grade = 'I' AND quarter = '1' AND school = 'East Central Integrated School'
                ) AS gradeone_lrns) AS totalone,
                (SELECT COUNT(DISTINCT lrn) FROM (
                    SELECT lrn FROM academic_english WHERE grade = 'II' AND quarter = '1' AND school = 'East Central Integrated School'
                    UNION
                    SELECT lrn FROM academic_filipino WHERE grade = 'II' AND quarter = '1' AND school = 'East Central Integrated School'
                    UNION
                    SELECT lrn FROM academic_numeracy WHERE grade = 'II' AND quarter = '1' AND school = 'East Central Integrated School'
                    UNION
                    SELECT lrn FROM behavioral WHERE grade = 'II' AND quarter = '1' AND school = 'East Central Integrated School'
                ) AS gradetwo_lrns) AS totaltwo,
                (SELECT COUNT(DISTINCT lrn) FROM (
                    SELECT lrn FROM academic_english WHERE grade = 'III' AND quarter = '1' AND school = 'East Central Integrated School'
                    UNION
                    SELECT lrn FROM academic_filipino WHERE grade = 'III' AND quarter = '1' AND school = 'East Central Integrated School'
                    UNION
                    SELECT lrn FROM academic_numeracy WHERE grade = 'III' AND quarter = '1' AND school = 'East Central Integrated School'
                    UNION
                    SELECT lrn FROM behavioral WHERE grade = 'III' AND quarter = '1' AND school = 'East Central Integrated School'
...
<?php
    ...
    $sqlKinderEnglish = "SELECT COUNT(LRN) AS count_kinder_english FROM academic_english WHERE grade = 'kinder' AND quarter = '1' AND school = 'East Central Integrated School'";
    ...
    $sqlKinderFilipino = "SELECT COUNT(LRN) AS count_kinder_filipino FROM academic_filipino WHERE grade = 'kinder' AND quarter = 1 AND school = 'East Central Integrated School'";
    ...
    $sqlKinderNumeracy = "SELECT COUNT(LRN) AS count_kinder_numeracy FROM academic_numeracy WHERE grade = 'kinder' AND quarter = 1 AND school = 'East Central Integrated School'";
    ...
    $sqlKinderBehavioral = "SELECT COUNT(LRN) AS count_kinder_behavioral FROM behavioral WHERE grade = 'kinder' AND quarter = 1 AND school = 'East Central Integrated School'";
    ...
    $sqlGradeIEnglish = "SELECT COUNT(LRN) AS count_grade_i_english FROM academic_english WHERE grade = 'I' AND quarter = 1 AND school = 'East Central Integrated School'";
    ...
    $sqlGradeIFilipino = "SELECT COUNT(LRN) AS count_grade_i_filipino FROM academic_filipino WHERE grade = 'I' AND quarter = 1 AND school = 'East Central Integrated School'";
    ...
    $sqlGradeINumeracy = "SELECT COUNT(LRN) AS count_grade_i_numeracy FROM academic_numeracy WHERE grade = 'I' AND quarter = 1 AND school = 'East Central Integrated School'";
    ...
    $sqlGradeIBehavioral = "SELECT COUNT(LRN) AS count_grade_i_behavioral FROM behavioral WHERE grade = 'I' AND quarter = 1 AND school = 'East Central Integrated School'";
    ...
    $sqlGradeIIEnglish = "SELECT COUNT(LRN) AS count_grade_ii_english FROM academic_english WHERE grade = 'II' AND quarter = 1 AND school = 'East Central Integrated School'";
    ...
    $sqlGradeIIFilipino = "SELECT COUNT(LRN) AS count_grade_ii_filipino FROM academic_filipino WHERE grade = 'II' AND quarter = 1 AND school = 'East Central Integrated School'";
    ...
    $sqlGradeIINumeracy = "SELECT COUNT(LRN) AS count_grade_ii_numeracy FROM academic_numeracy WHERE grade = 'II' AND quarter = 1 AND school = 'East Central Integrated School'";
    ...
    $sqlGradeIIBehavioral = "SELECT COUNT(LRN) AS count_grade_ii_behavioral FROM behavioral WHERE grade = 'II' AND quarter = 1 AND school = 'East Central Integrated School'";
    ...
    $sqlGradeIIIEnglish = "SELECT COUNT(LRN) AS count_grade_iii_english FROM academic_english WHERE grade = 'III' AND quarter = 1 AND school = 'East Central Integrated School'";
    ...
    $sqlGradeIIIFilipino = "SELECT COUNT(LRN) AS count_grade_iii_filipino FROM academic_filipino WHERE grade = 'III' AND quarter = 1 AND school = 'East Central Integrated School'";
    ...
    $sqlGradeIIINumeracy = "SELECT COUNT(LRN) AS count_grade_iii_numeracy FROM academic_numeracy WHERE grade = 'III' AND quarter = 1 AND school = 'East Central Integrated School'";
    ...
    $sqlGradeIIIBehavioral = "SELECT COUNT(LRN) AS count_grade_iii_behavioral FROM behavioral WHERE grade = 'III' AND quarter = 1 AND school = 'East Central Integrated School'";
...
foreach ($tables as $table) {
    ...
    $sql = "SELECT COUNT(DISTINCT lrn) AS total FROM $table WHERE grade = 'Kinder' AND gname <> '' AND quarter = 1 AND school = 'East Central Integrated School'";
    $sql1 = "SELECT COUNT(DISTINCT lrn) AS total1 FROM $table WHERE grade = 'Kinder' AND quarter = 1 AND school = 'East Central Integrated School'";    
    
    // Exclude LRNs that have been counted in previous tables
    if ($table !== $tables[0]) {
        $sql .= " AND lrn NOT IN (SELECT DISTINCT lrn FROM " . $tables[0] . " WHERE grade = 'Kinder' AND quarter = 1 AND school = 'East Central Integrated School')";
        $sql1 .= " AND lrn NOT IN (SELECT DISTINCT lrn FROM " . $tables[0] . " WHERE grade = 'Kinder' AND quarter = 1 AND school = 'East Central Integrated School')";
    }
...
foreach ($tables as $table) {
    // Construct SQL queries
    $sql = "SELECT COUNT(DISTINCT lrn) AS total FROM $table WHERE grade = 'I' AND gname <> '' AND quarter = 1 AND school = 'East Central Integrated School'";
    $sql1 = "SELECT COUNT(DISTINCT lrn) AS total1 FROM $table WHERE grade = 'I' AND quarter = 1 AND school = 'East Central Integrated School'";    
    
    // Exclude LRNs that have been counted in previous tables
    if ($table !== $tables[0]) {
        $sql .= " AND lrn NOT IN (SELECT DISTINCT lrn FROM " . $tables[0] . " WHERE grade = 'I' AND quarter = 1 AND school = 'East Central Integrated School')";
        $sql1 .= " AND lrn NOT IN (SELECT DISTINCT lrn FROM " . $tables[0] . " WHERE grade = 'I' AND quarter = 1 AND school = 'East Central Integrated School')";
    }
...
foreach ($tables as $table) {
    // Construct SQL queries
    $sql = "SELECT COUNT(DISTINCT lrn) AS total FROM $table WHERE grade = 'II' AND gname <> '' AND quarter = 1 AND school = 'East Central Integrated School'";
    $sql1 = "SELECT COUNT(DISTINCT lrn) AS total1 FROM $table WHERE grade = 'II' AND quarter = 1 AND school = 'East Central Integrated School'";    
    
    // Exclude LRNs that have been counted in previous tables
    if ($table !== $tables[0]) {
        $sql .= " AND lrn NOT IN (SELECT DISTINCT lrn FROM " . $tables[0] . " WHERE grade = 'II' AND quarter = 1 AND school = 'East Central Integrated School')";
        $sql1 .= " AND lrn NOT IN (SELECT DISTINCT lrn FROM " . $tables[0] . " WHERE grade = 'II' AND quarter = 1 AND school = 'East Central Integrated School')";
    }
...
foreach ($tables as $table) {
    // Construct SQL queries
    $sql = "SELECT COUNT(DISTINCT lrn) AS total FROM $table WHERE grade = 'III' AND gname <> '' AND quarter = 1 AND school = 'East Central Integrated School'";
    $sql1 = "SELECT COUNT(DISTINCT lrn) AS total1 FROM $table WHERE grade = 'III' AND quarter = 1 AND school = 'East Central Integrated School'";    
    
    // Exclude LRNs that have been counted in previous tables
    if ($table !== $tables[0]) {
        $sql .= " AND lrn NOT IN (SELECT DISTINCT lrn FROM " . $tables[0] . " WHERE grade = 'III' AND quarter = 1 AND school = 'East Central Integrated School')";
        $sql1 .= " AND lrn NOT IN (SELECT DISTINCT lrn FROM " . $tables[0] . " WHERE grade = 'III' AND quarter = 1 AND school = 'East Central Integrated School')";
    }
