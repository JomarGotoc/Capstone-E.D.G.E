...
if (isset($_POST['update'])) {
    ...
    if ($status === 'Resolved') {
        ...
        $sql_delete = "DELETE FROM $table WHERE lrn=? AND quarter IN ('3', '4') AND school = 'T. Ayson Rosario Elementary School'";
    ...
    $sql_update_all = "UPDATE $table SET status=? WHERE lrn=? AND quarter IN ('2', '3', '4') AND school = 'T. Ayson Rosario Elementary School'";
    ...
    $sql_update = "UPDATE $table SET gname=?, number=?, notes=?, intervention=?, topic=?, advice=? WHERE lrn=? AND quarter = '2' AND school = 'T. Ayson Rosario Elementary School'";
...
if (isset($_GET['lrn']) && isset($_GET['classification'])) {
    ...
    foreach ($tables as $table) {
        $query = "SELECT gname, number, grade, section FROM $table WHERE lrn = '$lrn' AND classification = '$classification' AND quarter = '2' AND school = 'T. Ayson Rosario Elementary School'";
