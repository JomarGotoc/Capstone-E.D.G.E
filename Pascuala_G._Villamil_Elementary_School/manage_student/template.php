...
if ($tableExistsResult->num_rows > 0) {
    $fetchQuery = "SELECT lrn, fullname, gender FROM $currentFileName WHERE school = 'Pascuala G. Villamil Elementary School'";
...
<body>
    ...
    <div class="navbar">
        <nav>
            <a href="../../.././Pascuala_G._Villamil_Elementary_School/school_admin_manage_account/Adviser_Account.php?employment_number=<?php echo isset($_GET['employment_number']) ? $_GET['employment_number'] : 'default_value'; ?>">Manage Accounts</a>
