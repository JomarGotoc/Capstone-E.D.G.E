    ...
    <div class="main-container" >
        <div class="navbar-container">
                <div class="navbar-content">
                    ...
                    <div class="navbar-item"><a href="grade_kinder_section1.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 1</a></div>
                    <div class="navbar-item"><a href="grade_kinder_section2.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 2</a></div>
                    <div class="navbar-item" ><a href="grade_kinder_section3.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 3</a></div>
                    <div class="navbar-item"><a href="grade_kinder_section4.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 4</a></div>
                    <div class="navbar-item"><a href="grade_kinder_section5.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 5</a></div>
                    <div class="navbar-item" style="background:#F3F3F3; color:#130550"><a href="grade_kinder_section6.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 6</a></div>
                    ...
                    <div class="navbar-item" ><a href="grade_1_section2.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 2</a></div>
                    <div class="navbar-item"><a href="grade_1_section3.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 3</a></div>
                    <div class="navbar-item"><a href="grade_1_section4.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 4</a></div>
                    <div class="navbar-item"><a href="grade_1_section5.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 5</a></div>
                    <div class="navbar-item"><a href="grade_1_section6.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 6</a></div>

                    <hr color="#0d054c" size="5" >
                    <div class="navbar-item title"><i class='bx bx-book-open' style="margin-right: 10px; font-size: 20px"></i>Grade 2</div>
                    <div class="navbar-item"><a href="grade_2_section1.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 1</a></div>
                    <div class="navbar-item"><a href="grade_2_section2.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 2</a></div>
                    <div class="navbar-item"><a href="grade_2_section3.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 3</a></div>
                    <div class="navbar-item"><a href="grade_2_section4.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 4</a></div>
                    <div class="navbar-item"><a href="grade_2_section5.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 5</a></div>
                    <div class="navbar-item"><a href="grade_2_section6.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 6</a></div>

                    <hr color="#0d054c" size="5" >
                    <div class="navbar-item title"><i class='bx bx-book-open' style="margin-right: 10px; font-size: 20px"></i>Grade 3</div>
                    <div class="navbar-item"><a href="grade_3_section1.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 1</a></div>
                    <div class="navbar-item"><a href="grade_3_section2.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 2</a></div>
                    <div class="navbar-item"><a href="grade_3_section3.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 3</a></div>
                    <div class="navbar-item"><a href="grade_3_section4.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 4</a></div>
                    <div class="navbar-item"><a href="grade_3_section5.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 5</a></div>
                    <div class="navbar-item"><a href="grade_3_section6.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 6</a></div>
