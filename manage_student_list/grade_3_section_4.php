...
<body>
    ...
    <div class="navbar">
        <nav>
            <a href="../school_admin_manage_account/Adviser_Account.phpp">Manage Accounts</a>
    ...
    <div class="navbar-container">
                <div class="navbar-content">
                    ...
                    <div class="navbar-item"style="background:#F3F3F3; color:#130550"><a href="grade_3_section_4.php"><i class='bx bx-circle' style="margin-right: 10px" ></i>Section 4</a></div>
