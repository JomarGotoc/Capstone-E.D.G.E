...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update"])) {
    ...
    $sql = "UPDATE $tableName SET 
            ...
            advice = ?,
            status = ?
            WHERE lrn = ? AND quarter = '3' AND school = 'Calmay Elementary School'";
...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    if (isset($_GET['lrn'])) {
        ...
        advice IS NOT NULL AND advice <> '' AND school = 'Calmay Elementary School' AND grade = '$grade' AND section = '$section'";
