...
if(isset($_POST['reset_password'])) {
    ...
    $query = "SELECT * FROM school_admin WHERE id = $user_id";
    ...
    if ($result->num_rows > 0) {
        ...
        $update_query = "UPDATE school_admin SET password = '$hashed_password' WHERE id = $user_id";
...
<body>
            ...
            <div class="header-content">
                ...
                <i class='bx log-out bx-lock-alt logout-icon' onclick="toggleDropdown()"></i>
                    <div class="dropdown-content" id="dropdownContent">
                        ...
                        <a href="../change_password/change_password.php?employment_number=<?php echo isset($_GET['employment_number']) ? $_GET['employment_number'] : 'default_value'; ?>&path=<?php echo $path ?>">Change Password</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="navbar">
        <nav>
            ...
            <a href="SDO_manageaccount2.php?employment_number=<?php echo isset($_GET['employment_number']) ? $_GET['employment_number'] : 'default_value'; ?>" id="division-admin">Executive Committee</a>
            <a href="SDO_manageaccount3.php?employment_number=<?php echo isset($_GET['employment_number']) ? $_GET['employment_number'] : 'default_value'; ?>" style="background:#F3F3F3; color:#130550" id="deped-admin">School Administrators</a>
        </nav>
    </div>
            ...
            ?>
                ...
                <td class="rows"><?php echo $row['date']; ?></td>
                    <td class="rows">
                        ...
                        <a href="SDO_manageaccount3_edit.php?id=<?php echo $row['id']; ?>&employment_number=<?php echo isset($_GET['employment_number']) ? $_GET['employment_number'] : 'default_value'; ?>"><button class="edit-button">Edit</button></a>
                        <form method="post" action="SDO_manageaccount3.php">
    ...
    <div class="plus-button">
            <a href="../SDO_Create_Account/Select_School.php?employment_number=<?php echo isset($_GET['employment_number']) ? $_GET['employment_number'] : 'default_value'; ?>"><button id="addRecordButton" class="add-button"><i class='bx bx-plus'></i></button></a>
        </div>
