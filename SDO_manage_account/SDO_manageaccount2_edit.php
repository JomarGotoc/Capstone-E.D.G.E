...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update"])) {
    ...
    $sql_update = "UPDATE executive_committee SET fullname='$new_full_name', password='$new_password', employment_number='$new_employment_number', date='$new_date' WHERE id=$id";
