...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update"])) {
    ...
    $sql_update = "UPDATE sdo_admin SET fullname='$new_full_name', password='$new_password', employment_number='$new_employment_number', date='$new_date' WHERE id=$id";

    if ($conn->query($sql_update) === TRUE) {
        header("Location: sdo_manageaccount.php_account.php");
    } else {
            ...
            <div class="row">
                ...
                <div class="columns">
                    <div class="form-group">
                        ...
                        <input type="email" id="email" name="email" value="<?php echo $password; ?>" required>
                    </div>
                    <div class="form-group">
