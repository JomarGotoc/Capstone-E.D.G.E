...
if ($tableExistsResult->num_rows > 0) {
    $fetchQuery = "SELECT lrn, fullname, gender FROM $currentFileName WHERE school = 'Malued Sur Elementary School'";
...
<body>
    ...
    <div class="navbar">
        <nav>
            <a href="../../.././Malued_Sur_Elementary_School/school_admin_manage_account/Adviser_Account.php">Manage Accounts</a>
