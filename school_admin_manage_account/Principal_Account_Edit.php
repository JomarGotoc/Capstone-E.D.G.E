...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update"])) {
    ...
    $sql_update = "UPDATE principal SET fullname='$new_full_name', password='$new_password', employment_number='$new_employment_number', date='$new_date' WHERE id=$id";
            ...
            <div class="row">
                <div class="columns">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="idnemployment_numberum" name="employment_number" value="<?php echo $employment_number; ?>" required>
                    </div>
                </div>
