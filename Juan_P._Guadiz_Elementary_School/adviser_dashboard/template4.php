...
<?php
    ...
    foreach ($tables as $table) {
        $sql = "SELECT COUNT(*) AS count FROM $table WHERE grade = '$secondWord' AND section = '$fourthWord' AND school = 'Juan P. GuadizElementary School'";
...
<?php
    ...
    function fetchTable($conn, $tableName, $grade, $section) {
        ...
        $sql = "SELECT lrn, fullname, classification, grade, section, status FROM $tableName WHERE grade = ? AND section = ? AND quarter = 4 AND school = 'Juan P. GuadizElementary School'";
...
<body>
    ...
    <div class="top-container">
        <div class="school">
            <h3>Juan P. GuadizElementary School</h3>
        </div>
    </div>   
