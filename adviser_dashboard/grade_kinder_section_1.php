    ...
    <div class="main-container">
        ...
        <div class="row">
            ...
            <div class="column half-width">
                <div class="containers" style="background-color: #F3F3F3;">
                    <h3 style="color: #190572; margin-left:7px"><?php echo $secondWord . '&nbsp;&nbsp;&nbsp;' . $fourthWord; ?>
</h3>
</h3>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="column half-width">
                <div class="containers" style="background-color: #F3F3F3;">
                    <h3 style="color: #190572; margin-left:7px"><?php echo $lrnCount ?></h3>
                </div>
            </div>
        </div>
        ...
        foreach ($tableData as $row) {
            echo "<tr class='sheshable'>
                    ...
                    <th style='width:15%' class='act'>
                        <a href='../index.php?update&lrn={$row['lrn']}&fullname={$row['fullname']}&classification={$row['classification']}'>
...
?>
        ...
        <div class="plus-button">
            <a href="../add_student_form/grade_kinder_section_1.php"> <button id="addRecordButton" class="add-button"><i class='bx bx-plus'></i></button></a>
        </div>
