...
<?php
    ...
    function fetchTable($conn, $tableName, $grade, $section) {
        ...
        $sql = "SELECT lrn, fullname, classification, grade, section FROM $tableName WHERE grade = ? AND section = ?";
...
?>
    ...
    document.addEventListener("DOMContentLoaded", function () {
        function showPopup() {
            ...
            var grade = row.querySelector('th:nth-child(4)').textContent; // Assuming 4th column is for grade
            var section = row.querySelector('th:nth-child(5)').textContent; // Assuming 5th column is for section
