...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["update"])) {
    ...
    $sql = "INSERT INTO adviser_intervention_third_period (lrn, fullname, grade, identification, gname, number, notes, intervention, topic, advice, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
if ($_SERVER["REQUEST_METHOD"] == "GET") {
    ...
    if (isset($_GET['lrn'])) {
        ...
        $sql = "SELECT COUNT(*) as count FROM adviser_intervention_third_period WHERE lrn = '$lrn'";
...
<body>
    ...
    <div class="top-container">
        ...
        <a href="adviser_intervention_thirdperiod_view.php"><button class="update" >Update Record</button></a>
    </div>
