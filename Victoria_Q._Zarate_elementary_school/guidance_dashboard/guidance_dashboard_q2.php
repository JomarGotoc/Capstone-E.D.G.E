<?php
    ...
    $sql = "SELECT lrn, fullname, classification, grade, section, status FROM behavioral WHERE quarter ='2' AND school = 'Victoria Q. Zarate Elementary School'";
...
<?php
include('../../database.php');
$sql = "SELECT COUNT(*) AS count FROM behavioral WHERE lrn IS NOT NULL AND lrn != '' AND school = 'Victoria Q. Zarate Elementary School'";
