<?php
    ...
    if (count($words) >= 4) {
        $secondWord = $words[1];
        $fourthWord = $words[3];
        $sql = "SELECT employment_number, fullname FROM adviser WHERE grade = '$secondWord' AND section = '$fourthWord' AND school = 'SVictoria Q. Zarate Elementary School'";
...
foreach ($tables as $table) {
    $sql = "SELECT lrn FROM $table WHERE grade = '$secondWord' AND section = '$fourthWord' AND school = 'SVictoria Q. Zarate Elementary School'";
...
<?php
    ...
    function fetchTable($conn, $tableName, $grade, $section) {
        ...
        $sql = "SELECT lrn, fullname, classification, grade, section, status FROM $tableName WHERE grade = ? AND section = ? AND quarter = 3 AND school = 'SVictoria Q. Zarate Elementary School'";
...
<body>
    ...
    <div class="top-container">
        <div class="school">
            <h3>SVictoria Q. Zarate Elementary School</h3>
        </div>
    </div>   
