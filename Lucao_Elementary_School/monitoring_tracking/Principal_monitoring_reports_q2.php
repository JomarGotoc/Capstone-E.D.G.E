...
<?php
    ...
    $sql = "SELECT
                (SELECT COUNT(DISTINCT lrn) FROM (
                    SELECT lrn FROM academic_english WHERE grade = 'kinder' AND quarter = 2 AND school = 'Lucao Elementary School'
                    UNION
                    SELECT lrn FROM academic_filipino WHERE grade = 'kinder' AND quarter = 2 AND school = 'Lucao Elementary School'
                    UNION
                    SELECT lrn FROM academic_numeracy WHERE grade = 'kinder' AND quarter = 2 AND school = 'Lucao Elementary School'
                    UNION
                    SELECT lrn FROM behavioral WHERE grade = 'kinder' AND quarter = 2 AND school = 'Lucao Elementary School'
                ) AS kinder_lrns) AS totalkinder,
                (SELECT COUNT(DISTINCT lrn) FROM (
                    SELECT lrn FROM academic_english WHERE grade = 'I' AND quarter = 2 AND school = 'Lucao Elementary School'
                    UNION
                    SELECT lrn FROM academic_filipino WHERE grade = 'I' AND quarter = 2 AND school = 'Lucao Elementary School'
                    UNION
                    SELECT lrn FROM academic_numeracy WHERE grade = 'I' AND quarter = 2 AND school = 'Lucao Elementary School'
                    UNION
                    SELECT lrn FROM behavioral WHERE grade = 'I' AND quarter = 2 AND school = 'Lucao Elementary School'
                ) AS gradeone_lrns) AS totalone,
                (SELECT COUNT(DISTINCT lrn) FROM (
                    SELECT lrn FROM academic_english WHERE grade = 'II' AND quarter = 2 AND school = 'Lucao Elementary School'
                    UNION
                    SELECT lrn FROM academic_filipino WHERE grade = 'II' AND quarter = 2 AND school = 'Lucao Elementary School'
                    UNION
                    SELECT lrn FROM academic_numeracy WHERE grade = 'II' AND quarter = 2 AND school = 'Lucao Elementary School'
                    UNION
                    SELECT lrn FROM behavioral WHERE grade = 'II' AND quarter = 2 AND school = 'Lucao Elementary School'
                ) AS gradetwo_lrns) AS totaltwo,
                (SELECT COUNT(DISTINCT lrn) FROM (
                    SELECT lrn FROM academic_english WHERE grade = 'III' AND quarter = 2 AND school = 'Lucao Elementary School'
                    UNION
                    SELECT lrn FROM academic_filipino WHERE grade = 'III' AND quarter = 2 AND school = 'Lucao Elementary School'
                    UNION
                    SELECT lrn FROM academic_numeracy WHERE grade = 'III' AND quarter = 2 AND school = 'Lucao Elementary School'
                    UNION
                    SELECT lrn FROM behavioral WHERE grade = 'III' AND quarter = 2 AND school = 'Lucao Elementary School'
...
<?php
    ...
    $sqlKinderEnglish = "SELECT COUNT(LRN) AS count_kinder_english FROM academic_english WHERE grade = 'kinder' AND quarter =2 AND school = 'Lucao Elementary School'";
    ...
    $sqlKinderFilipino = "SELECT COUNT(LRN) AS count_kinder_filipino FROM academic_filipino WHERE grade = 'kinder' AND quarter =2 AND school = 'Lucao Elementary School'";
    ...
    $sqlKinderNumeracy = "SELECT COUNT(LRN) AS count_kinder_numeracy FROM academic_numeracy WHERE grade = 'kinder' AND quarter =2 AND school = 'Lucao Elementary School'";
    ...
    $sqlKinderBehavioral = "SELECT COUNT(LRN) AS count_kinder_behavioral FROM behavioral WHERE grade = 'kinder' AND quarter =2 AND school = 'Lucao Elementary School'";
    ...
    $sqlGradeIEnglish = "SELECT COUNT(LRN) AS count_grade_i_english FROM academic_english WHERE grade = 'I' AND quarter =2 AND school = 'Lucao Elementary School'";
    ...
    $sqlGradeIFilipino = "SELECT COUNT(LRN) AS count_grade_i_filipino FROM academic_filipino WHERE grade = 'I' AND quarter =2 AND school = 'Lucao Elementary School'";
    ...
    $sqlGradeINumeracy = "SELECT COUNT(LRN) AS count_grade_i_numeracy FROM academic_numeracy WHERE grade = 'I' AND quarter =2 AND school = 'Lucao Elementary School'";
    ...
    $sqlGradeIBehavioral = "SELECT COUNT(LRN) AS count_grade_i_behavioral FROM behavioral WHERE grade = 'I' AND quarter =2 AND school = 'Lucao Elementary School'";
    ...
    $sqlGradeIIEnglish = "SELECT COUNT(LRN) AS count_grade_ii_english FROM academic_english WHERE grade = 'II' AND quarter =2 AND school = 'Lucao Elementary School'";
    ...
    $sqlGradeIIFilipino = "SELECT COUNT(LRN) AS count_grade_ii_filipino FROM academic_filipino WHERE grade = 'II' AND quarter =2 AND school = 'Lucao Elementary School'";
    ...
    $sqlGradeIINumeracy = "SELECT COUNT(LRN) AS count_grade_ii_numeracy FROM academic_numeracy WHERE grade = 'II' AND quarter =2 AND school = 'Lucao Elementary School'";
    ...
    $sqlGradeIIBehavioral = "SELECT COUNT(LRN) AS count_grade_ii_behavioral FROM behavioral WHERE grade = 'II' AND quarter =2 AND school = 'Lucao Elementary School'";
    ...
    $sqlGradeIIIEnglish = "SELECT COUNT(LRN) AS count_grade_iii_english FROM academic_english WHERE grade = 'III' AND quarter =2 AND school = 'Lucao Elementary School'";
    ...
    $sqlGradeIIIFilipino = "SELECT COUNT(LRN) AS count_grade_iii_filipino FROM academic_filipino WHERE grade = 'III' AND quarter =2 AND school = 'Lucao Elementary School'";
    ...
    $sqlGradeIIINumeracy = "SELECT COUNT(LRN) AS count_grade_iii_numeracy FROM academic_numeracy WHERE grade = 'III' AND quarter =2 AND school = 'Lucao Elementary School'";
    ...
    $sqlGradeIIIBehavioral = "SELECT COUNT(LRN) AS count_grade_iii_behavioral FROM behavioral WHERE grade = 'III' AND quarter =2 AND school = 'Lucao Elementary School'";
...
foreach ($tables as $table) {
    ...
    $sql = "SELECT COUNT(DISTINCT lrn) AS total FROM $table WHERE grade = 'Kinder' AND gname <> '' AND quarter = 2 AND school = 'Lucao Elementary School'";
    $sql1 = "SELECT COUNT(DISTINCT lrn) AS total1 FROM $table WHERE grade = 'Kinder' AND quarter = 2 AND school = 'Lucao Elementary School'";    
    
    // Exclude LRNs that have been counted in previous tables
    if ($table !== $tables[0]) {
        $sql .= " AND lrn NOT IN (SELECT DISTINCT lrn FROM " . $tables[0] . " WHERE grade = 'Kinder' AND quarter = 2 AND school = 'Lucao Elementary School')";
        $sql1 .= " AND lrn NOT IN (SELECT DISTINCT lrn FROM " . $tables[0] . " WHERE grade = 'Kinder' AND quarter = 2 AND school = 'Lucao Elementary School')";
    }
...
foreach ($tables as $table) {
    // Construct SQL queries
    $sql = "SELECT COUNT(DISTINCT lrn) AS total FROM $table WHERE grade = 'I' AND gname <> '' AND quarter = 2 AND school = 'Lucao Elementary School'";
    $sql1 = "SELECT COUNT(DISTINCT lrn) AS total1 FROM $table WHERE grade = 'I' AND quarter = 2 AND school = 'Lucao Elementary School'";    
    
    // Exclude LRNs that have been counted in previous tables
    if ($table !== $tables[0]) {
        $sql .= " AND lrn NOT IN (SELECT DISTINCT lrn FROM " . $tables[0] . " WHERE grade = 'I' AND quarter = 2 AND school = 'Lucao Elementary School')";
        $sql1 .= " AND lrn NOT IN (SELECT DISTINCT lrn FROM " . $tables[0] . " WHERE grade = 'I' AND quarter = 2 AND school = 'Lucao Elementary School')";
    }
...
foreach ($tables as $table) {
    // Construct SQL queries
    $sql = "SELECT COUNT(DISTINCT lrn) AS total FROM $table WHERE grade = 'II' AND gname <> '' AND quarter = 2 AND school = 'Lucao Elementary School'";
    $sql1 = "SELECT COUNT(DISTINCT lrn) AS total1 FROM $table WHERE grade = 'II' AND quarter = 2 AND school = 'Lucao Elementary School'";    
    
    // Exclude LRNs that have been counted in previous tables
    if ($table !== $tables[0]) {
        $sql .= " AND lrn NOT IN (SELECT DISTINCT lrn FROM " . $tables[0] . " WHERE grade = 'II' AND quarter = 2 AND school = 'Lucao Elementary School')";
        $sql1 .= " AND lrn NOT IN (SELECT DISTINCT lrn FROM " . $tables[0] . " WHERE grade = 'II' AND quarter = 2 AND school = 'Lucao Elementary School')";
    }
...
foreach ($tables as $table) {
    // Construct SQL queries
    $sql = "SELECT COUNT(DISTINCT lrn) AS total FROM $table WHERE grade = 'III' AND gname <> '' AND quarter = 2 AND school = 'Lucao Elementary School'";
    $sql1 = "SELECT COUNT(DISTINCT lrn) AS total1 FROM $table WHERE grade = 'III' AND quarter = 2 AND school = 'Lucao Elementary School'";    
    
    // Exclude LRNs that have been counted in previous tables
    if ($table !== $tables[0]) {
        $sql .= " AND lrn NOT IN (SELECT DISTINCT lrn FROM " . $tables[0] . " WHERE grade = 'III' AND quarter = 2 AND school = 'Lucao Elementary School')";
        $sql1 .= " AND lrn NOT IN (SELECT DISTINCT lrn FROM " . $tables[0] . " WHERE grade = 'III' AND quarter = 2 AND school = 'Lucao Elementary School')";
    }
