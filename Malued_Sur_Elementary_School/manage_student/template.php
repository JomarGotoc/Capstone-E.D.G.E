...
if ($tableExistsResult->num_rows > 0) {
    $fetchQuery = "SELECT lrn, fullname, gender FROM $currentFileName WHERE school = 'Malued_Sur_Elementary_School'";
...
<?php
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["submit"])) {
        ...
        $gender = $_POST["gender"];
        $school = "Malued_Sur_Elementary_School";
...
<body>
    ...
    <div class="navbar">
        <nav>
            <a href="../../.././Malued_Sur_Elementary_School/school_admin_manage_account/Adviser_Account.php?employment_number=<?php echo isset($_GET['employment_number']) ? $_GET['employment_number'] : 'default_value'; ?>">Manage Accounts</a>
